                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-3 col-sm-4">
                                        <input type="text" class="form-control bg-light border-light" id="dateRangePicker" placeholder="Select date range" />
                                    </div>
                                    <!--end col-->
...
$( document ).ready(function() {
    ...
    updateTaskList();
    $("#showAddModalBtn").click(function(){$("#showAddModal").modal('show');});
