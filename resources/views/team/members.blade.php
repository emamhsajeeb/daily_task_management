        ...
        (document.querySelector("#team-member-list").innerHTML = ""),
            Array.from(e).forEach(function (e, t) {
                ...
                (document.querySelector("#team-member-list").innerHTML +=
                        ...
                        '                       <div class="col-12">' +
                        '                       <div class="btn-group">' +
                        '                        <button class="btn btn-light btn-sm dropdown-toggle dropdown-toggle-split" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">' + (e.role === 'admin' ? 'Admin' : (e.role === 'se' ? 'Supervision Engineer' : '')) + '</button>' +
